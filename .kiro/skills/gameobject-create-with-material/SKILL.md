---
name: gameobject-create-with-material
description: Create a new GameObject with a specified color material in opened Prefab or in a Scene. If needed - provide proper 'position', 'rotation' and 'scale' to reduce amount of operations.
---

# GameObject / Create with Material

## How to Call

```bash
unity-mcp-cli run-tool gameobject-create-with-material --input '{
  "name": "string_value",
...
> ```bash
> unity-mcp-cli run-tool gameobject-create-with-material --input-file args.json
> ```
>
> Or pipe via stdin (recommended):
> ```bash
> unity-mcp-cli run-tool gameobject-create-with-material --input-file - <<'EOF'
> {"param": "value"}
> EOF
> ```
...
| `color` | `any` | No | The color of the material to be applied to the GameObject. |
